...
* An authentication system with a User model. I use https://rubygems.org/gems/authenticate
...
A user-to-organization system you might be familiar with: Basecamp's concepts of accounts and users.
